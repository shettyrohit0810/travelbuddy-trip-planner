...
def post_form(url: str, data: dict, headers: Optional[dict] = None) -> Any:
    """Stdlib-only JSON-returning POST with form-encoded body (used for OAuth2 client-credentials)."""
